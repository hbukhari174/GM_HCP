...
u = Tableofallsubjects(strcmp(Tableofallsubjects.Sex, "M"), :)
v = Tableofallsubjects(strcmp(Tableofallsubjects.Sex, "M"), :)
%Z = T;
...
shading interp
colormap('turbo')
title('Pairwise Swaps of Males Over Age')
xlabel('Age')
ylabel('Age')
zlabel('Swaps')
exportgraphics(gcf,('surfforMalesOverage_latest.JPEG'))
% saveas(gcf,('surfforMalesOverage-ex35.fig'));
